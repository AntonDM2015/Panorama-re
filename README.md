# 🏛️ Panorama 360 — Виртуальный тур по кампусу
...
- **🗺️ Навигация Street View**: Перемещение между связанными точками с хотспотами и автоматическими переходами
- **🏙️ Многокампусная архитектура**: Иерархия Город → Здание → Локация → Панорама с поддержкой нескольких городов
...
- ✅ Загрузка и управление панорамами
- ✅ Навигация Street View
- ✅ Отображение панорам в WebGL2
...
- **RÉU им. Г.В. Плеханова** — за поддержку проекта
...
<div align="center">
  <strong>Сделано с ❤️ командой Panorama 360</strong>
</div>
